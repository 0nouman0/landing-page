          ...
          <div className="max-w-none mx-auto px-2 sm:px-4 lg:px-6">
            <div className="mx-auto grid gap-10 lg:grid-cols-2 items-center">
              ...
              <div className="order-2 lg:order-1">
                <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 lobster-two-regular">Create your account</h1>
                <p className="text-gray-600 mb-6">
                  Get started with AI-powered document analysis, faster reviews, and accurate recommendations.
                </p>
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-primary-600"></span> 14-day free trial</li>
                  <li className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-secondary-600"></span> Google or email & password</li>
                  <li className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-accent-600"></span> SOC 2 alignment</li>
                </ul>
              </div>
                  ...
                  <div className="bg-white p-8 rounded-2xl shadow border border-gray-200">
                    ...
                    <div className="space-y-4">
                      ...
                      <form className="space-y-4">
                        <input disabled type="text" placeholder="Full name" className="w-full border border-gray-300 rounded-lg px-4 py-3" />
                        <input disabled type="email" placeholder="Work email" className="w-full border border-gray-300 rounded-lg px-4 py-3" />
                        <input disabled type="password" placeholder="Password" className="w-full border border-gray-300 rounded-lg px-4 py-3" />
                        <button disabled className="w-full bg-primary-600 text-white px-4 py-3 rounded-lg font-semibold opacity-60">Create account</button>
                      </form>
                      <p className="text-sm text-gray-600 text-center">Already have an account? <Link href="/sign-in" className="text-primary-600 font-semibold">Sign in</Link></p>
                    </div>
                  </div>
                )}
                {/* Kroolo SSO */}
